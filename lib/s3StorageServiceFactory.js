...
class S3StorageServiceFactory {
     ...
     * @property {String} urlStyle - url style to use - http://docs.aws.amazon.com/AmazonS3/latest/dev/UsingBucket.html
    ...
    static createAwsS3Client(config) {
        ...
        if (config.s3Config.httpTimeoutMs) {
            s3Config.httpOptions = {
                timeout: config.s3Config.httpTimeoutMs
            }
        }
